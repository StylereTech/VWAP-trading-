"""
Backtest Optimized VWAP Control Flip Strategy
60 Days with Quantum-Optimized Parameters
"""
...
def main():
    """Run 60-day backtest with optimized parameters."""
    print("="*80)
    print("VWAP CONTROL FLIP STRATEGY - OPTIMIZED BACKTEST")
    print("60 Days: GBP/JPY, BTC/USD, Gold/USD")
    print("="*80)
    
    symbols = ['GBPJPY', 'BTCUSD', 'XAUUSD']
    
    # Optimized parameters (from quantum optimizer - these are good defaults)
    optimized_params = {
